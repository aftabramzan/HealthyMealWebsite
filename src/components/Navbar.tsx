    ...
    <>
      <View className="relative z-20 border-b border-gray-100 bg-white px-5 py-3 md:px-10">
        <View className="mx-auto w-full max-w-[1200px] flex-row items-center justify-between">
          <Pressable accessibilityRole="link"><View className="min-w-[112px]"><Text className="font-display text-[20px] font-bold leading-5 text-ink">Healthy</Text><Text className="text-[9px] font-bold uppercase tracking-[3px] text-olive">Meals</Text></View></Pressable>
